...
<li class="page_item page-item-2"><a href="http://jjvang.github.io/wordpress/sample-page/">Sample Page</a></li>
				...
				<main id="main" class="site-main" role="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<form role="search" method="get" class="search-form" action="http://jjvang.github.io/wordpress/">
				<label>
		...
		<select id="archives-dropdown--1" name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
			...
			<option value="">Select Month</option>
				<option value='http://jjvang.github.io/wordpress/2018/06/'> June 2018 </option>
